  ...
  // ===== LOGO ATUALIZADA PARA SER CONTROLADA PELO CSS =====
  const Logo = ({ isAnimated }) => (
    <svg className="logo-svg" viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg">
      ...
      >
        ...
        <rect x="56" y="56" width="88" height="88" />
        <rect x="38.5" y="38.5" width="123" height="123" transform="rotate(45 100 100)" />
        <rect x="44.5" y="44.5" width="111" height="111" transform="rotate(45 100 100)" />
      </g>
      {/* Estilos como fontWeight foram movidos para o App.css */}
      <g className="logo-letters-group">
        {/* Adicionamos uma className na letra C para movê-la com CSS */}
        <text className="logo-letter-c" x="88" y="122" fontSize="58">C</text>
        <text x="124" y="130" fontSize="72">A</text>
      </g>
    </svg>
  );
